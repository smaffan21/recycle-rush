...
public class GameManagerScript_ArcadeSummary : MonoBehaviour
{
    public GameObject[] spawnables;
    public DespawnerScript_FunFact despawnerScript;
    public Text plasticText, metalText, glassText, paperText, totalText;
    ...
    {
        plasticText.text = "Plastic Recycled: " + PlayerScript.plastickWH + " kWH";
        glassText.text = "Glass Recycled: " + PlayerScript.glasskWH + " kWH"; 
        metalText.text = "Metal Recycled: " + PlayerScript.metalkWH + " kWH";
        paperText.text = "Paper Recycled: " + PlayerScript.paperkWH + " kWH";
        
        totalText.text = "TOTAL RECYCLED: " + PlayerScript.energySaved + " kWH";
    }

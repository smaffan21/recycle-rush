...
public class GameManagerScript_Level2 : MonoBehaviour
{
    public GameObject[] spawnables;
    public DespawnerScript_Level2 despawnerScript;
    public PlayerScript_Level2 playerScript;
    public Text text; 
    ...
    public void Start()
    {
        ...
        InvokeRepeating("SpawnObject", 0.5f, 1.7f);
    }
    ...
    void SpawnObject() 
    {
        ...
        if (chance > 40 && chance <= 60) { // plastic

...
public class GameManagerScript_Level3 : MonoBehaviour
{
    public GameObject[] spawnables;
    public DespawnerScript_Level3 despawnerScript;
    public PlayerScript_Level3 playerScript;
    public Text text; 
    ...
    public void Start()
    {
        ...
        InvokeRepeating("SpawnObject", 0.5f, 1.6f);
    }
    ...
    void SpawnObject() 
    {
        ...
        if (chance > 60 && chance <= 80) { // plastic
